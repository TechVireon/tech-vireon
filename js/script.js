document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            fetch("https://formsubmit.co/ajax/techvireon@gmail.com", {
                method: "POST",
                body: formData
            })
            ...
            .then(data => {
                ...
                if (data.success || data.success === "true") {
                    ...
                    // This happens if the form needs to be activated (FormSubmit first-time use)
                    alert('Form submitted! Please check techvireon@gmail.com to activate the form for the first time if you haven\'t yet.');
                    contactForm.reset();
                }
            })
            .catch(error => {
